 ...
 */
public class DomainDetailServicesScaffolder extends AbstractContextScaffolder {
   ...
   */
  public DomainDetailServicesScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    Path modulePath =
        Paths.get(
            ...
            contextDescription.getModulePrefix() + "domain-detail-services");
