...
package com.oregor.trinity.scaffolder.java.core.bom;
 ...
 */
public class BomScaffolder extends AbstractContextScaffolder {
   ...
   */
  public BomScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    Path modulePath =
        Paths.get(generationPath.toString(), contextDescription.getModulePrefix() + "bom");

    ensureSources(modulePath, contextDescription);

    freemarkerService.exportIfNotExists(
        dataModel,
        "trinity-scaffolder-java/bom/pom.xml.ftl",
