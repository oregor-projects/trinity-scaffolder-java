...
package com.oregor.trinity.scaffolder.java.core.commons;
...
/**
 * The type Commons module scaffolder.
 *
 * @author Christos Tsakostas
 */
public class CommonsModuleScaffolder extends AbstractProjectScaffolder {
  ...
  /**
   * Instantiates a new Commons module scaffolder.
   *
   * @param freemarkerService the freemarker service
   */
  public CommonsModuleScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    scaffoldModule(generationPath, projectDescription, dataModel, module);
  }
