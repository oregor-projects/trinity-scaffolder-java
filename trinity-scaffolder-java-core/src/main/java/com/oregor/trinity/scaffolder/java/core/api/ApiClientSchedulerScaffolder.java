...
/**
 * The type Api client scheduler scaffolder.
 *
 * @author Christos Tsakostas
 */
public class ApiClientSchedulerScaffolder extends AbstractContextScaffolder {
  ...
  /**
   * Instantiates a new Api client scheduler scaffolder.
   *
   * @param freemarkerService the freemarker service
   */
  public ApiClientSchedulerScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    Path modulePath =
        Paths.get(
            ...
            contextDescription.getModulePrefix() + "api-client-scheduler-camel");
