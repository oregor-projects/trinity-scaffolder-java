 ...
 */
public class AuxScaffolder extends AbstractContextScaffolder {
   ...
   */
  public AuxScaffolder(FreemarkerService freemarkerService) {
  ...
  public void scaffold(
    ...
    Path modulePath =
        Paths.get(generationPath.toString(), contextDescription.getModulePrefix() + "aux");
